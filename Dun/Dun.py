...
class DUN:
    ...
    def ReadyInterface(self):
        ...
        Label(self.frame3, width=300, height=500, bg='white').place(x=0, y=190)
        ...
        self.PCinfoFrame = Frame(self.frame3, width=300, height=500, bg='white')
        self.PCinfoFrame.place(x=0, y=190)
        self.PCname = Label(self.PCinfoFrame, text='',bg='white')
        self.PCname.pack()
        self.PCopenDate = Label(self.PCinfoFrame, text='',bg='white')
        self.PCopenDate.pack()
        self.PCLOTNO = Label(self.PCinfoFrame, text='',bg='white')
        self.PCLOTNO.pack()
        self.PCROADNM = Label(self.PCinfoFrame, text='',bg='white')
        self.PCROADNM.pack()
        self.PCZIP = Label(self.PCinfoFrame, text='',bg='white')
        self.PCZIP.pack()
        self.PCWGSX = Label(self.PCinfoFrame, text='',bg='white')
        self.PCWGSX.pack()
        self.PCWGSY = Label(self.PCinfoFrame, text='',bg='white')
        self.PCWGSY.pack()
    ...
    def printGraph(self):
        ...
        for key, value in fameDict.items():
            ...
            self.graphCanvas.create_text(x1 + bar_width / 2 -6, y0 + 100, text=key, anchor='n', angle=90, tags='graph')
    ...
    def selectPCList(self,event):
        ...
        self.PCname.config(wraplength=300)
        self.PCname.configure(text="시설 이름: "+self.PCroomList[tt].BIZPLC_NM)
        self.PCopenDate.config(wraplength=300)
        ...
        self.PCZIP.config(wraplength=300)
        self.PCZIP.configure(text="우편번호: " + self.PCroomList[tt].ZIP_CD)
        self.PCWGSX.config(wraplength=300)
